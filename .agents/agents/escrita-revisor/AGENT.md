...
## Processo
1. Verificar que o texto tem entre 1000 e 2000 caracteres.
2. Conferir que as fontes são ≤5, com peso, corretas e ancoradas nas pesquisas.
3. Conferir que o draft está em `content/drafts/` com status `draft`.
4. Conferir que o registro editorial está em `content/drafts/`.
